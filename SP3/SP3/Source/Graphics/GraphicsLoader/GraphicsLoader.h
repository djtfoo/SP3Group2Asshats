...
public:
	...
	enum GEOMETRY_TYPE
	{
		...
		GEO_FALLINGLEAF_PARTICLE,
		GEO_DUST_PARTICLE,
		GEO_FALLINGROCK_PARTICLE,
		GEO_MUDBUBBLE_PARTICLE,

        // Monster states
        GEO_MONSTERSTATE_EXCLAMATION_MARK,
        GEO_MONSTERSTATE_QUESTION_MARK,
		GEO_MONSTERSTATE_RAMPAGE,
        GEO_MONSTERSTATE_TRAPPED,
        ...
        GEO_GRASSZONE_CAPTURE,
        GEO_GRASSZONE_CAPTURE_ALT,
        GEO_FIREZONE_CAPTURE,
        GEO_FIREZONE_CAPTURE_ALT,
        GEO_ROCKZONE_CAPTURE,
        GEO_ROCKZONE_CAPTURE_ALT,
        GEO_SWAMPZONE_CAPTURE,
        GEO_SWAMPZONE_CAPTURE_ALT,

        GEO_ENCLOSURE_INTERFACE,
        GEO_ICON_LEFT_ARROW,
        GEO_ICON_RIGHT_ARROW,
        GEO_ICON_GRASS,
        GEO_ICON_FIRE,
        GEO_ICON_ROCK,
        GEO_ICON_SWAMP,
